...
const CONSOLE = (params.get("console") || "http://127.0.0.1:8090/").replace(/\/?$/, "/");
$$(".console-link").forEach((a) => { a.href = CONSOLE; });
$$("[data-console-url]").forEach((el) => { el.textContent = CONSOLE.replace(/^https?:\/\//, ""); });
